...
public class MoneySendCommandListener implements Listener {
    private final Reincarceration plugin;
    private final PermissionManager permissionManager;
    private final DataManager dataManager;
    private final EconomyManager economyManager;

    public MoneySendCommandListener(Reincarceration plugin) {
        this.plugin = plugin;
    ...
    public void onPlayerCommandPreprocess(PlayerCommandPreprocessEvent event) throws SQLException {
        ...
        if (args.length >= 4 && args[0].equals("/money") && args[1].equals("send")) {
            ...
            try {
                ...
                ConsoleUtil.sendInfo("Invalid amount format: " + args[3]);
                return;
            }
